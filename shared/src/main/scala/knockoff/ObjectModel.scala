...
case class Link(children: collection.Seq[Span], url: String, title: Option[String]) extends Span

case class IndirectLink(children: collection.Seq[Span], definition: LinkDefinition) extends Span

case class ImageLink(children: collection.Seq[Span], url: String, title: Option[String]) extends Span

case class IndirectImageLink(children: collection.Seq[Span], definition: LinkDefinition) extends Span
...
case class Header(level: Int, spans: collection.Seq[Span], position: Position) extends Block

case class LinkDefinition(id: String, url: String, title: Option[String], position: Position) extends Block

case class Blockquote(children: collection.Seq[Block], position: Position) extends Block

case class CodeBlock(text: Text, position: Position) extends Block

case class HorizontalRule(position: Position) extends Block

case class OrderedItem(children: collection.Seq[Block], position: Position) extends Block

case class UnorderedItem(children: collection.Seq[Block], position: Position) extends Block

case class HTMLBlock(html: String, position: Position) extends Block
